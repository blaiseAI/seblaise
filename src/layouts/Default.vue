      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/">
            <g-image src="../../static/logo_light.svg" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/">
            <g-image src="../../static/logo_dark.svg" class="w-40" alt="logo" />
          </g-link>
        </div>
        ...
        >
          ...
          <li>
            <g-link
              to="https://standardresume.co/r/seblaise"
              class="text-copy-primary hover:text-gray-600"
            >Resume</g-link>
          </li>
          <li>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:hello@seblaise.dev" class="text-white hover:text-gray-400">
          ...
          <li>
            <a
              href="https://twitter.com/BlaiseSebagabo"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
          ...
          <li>
            <a
              href="https://codepen.io/blaiseai"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
